...
<html>
	<head>
		...
		<style type="text/css">
			...
			input[type=button]#lastYear:hover {
				color: black;
				background-color: Transparent;
				font-weight: bold;
			}
		...
		<script type="text/javascript">		
			$(document).ready(function(){				
				...
				$("#update").click(function(){
					...
					if(sessionEdept == '점포관리부' || sessionEpos == '사장'){
						...
						$("#salesForm").attr("action", "/chainCo/branch/list.do");
						$("#salesForm").attr("target", "pop");
						$("#salesForm").submit();
					}else{
				...
				$("#delete").click(function(){
					...
					if(sessionEdept == '점포관리부' || sessionEpos == '사장'){
						$("#salesForm").attr("action", "/chainCo/branch/branchDelete.do");
						$("#salesForm").submit();
					}else{
				...
				$("#sales").click(function(){
					$("#salesForm").attr("action", "/chainCo/branch/sales.do");
					$("#salesForm").submit();
				});
				
				$("#lastYear").click(function(){
					$("#salesForm").attr("action", "/chainCo/branch/lastYear.do");
					$("#salesForm").submit();
				});
			...
			function branches(branch){
				...
				$("#salesForm").attr("action", "/chainCo/branch/branchList.do");
				$("#salesForm").submit();
			}	
	...
	ArrayList salesList = (ArrayList)request.getAttribute("sales");
	BranchVO bv = null;
	...
	%>
		...
		<section>
			<div id="content">
			<br><br>
			<input type="button" name="lastYear" id="lastYear" value="이전년도 정보보기" />
			<br>
			<center>
				<%
